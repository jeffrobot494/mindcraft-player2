const settings = {
    ...
    "block_place_delay": .25, // delay between placing blocks (ms) if using newAction. helps avoid bot being kicked by anti-cheat mechanisms on servers.
